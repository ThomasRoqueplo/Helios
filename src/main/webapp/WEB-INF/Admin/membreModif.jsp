				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									Modifier un membre <small></small>
								</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">
								<div id="example_wrapper" class="dataTables_wrapper" role="grid">
									...
									<div class="clear"></div>
									<form role="form" method="post" action="membremodifier">
										...
										<div class="form-group">
											<label>Prénom:</label> <input type="text"
												...
												value="${membre.prenom_Membre}">
										</div>
										<div class="form-group">
											<label>Rôle :</label> <input type="text"
												class="form-control" name="job" id="job"
												value="${membre.job_Membre}">
										</div>
										<div class="form-group">
											<label>Mail:</label> <input type="email"
												class="form-control" id="mail" name="mail"
												value="${membre.mail_Membre}">
										</div>
										<div class="form-group">
