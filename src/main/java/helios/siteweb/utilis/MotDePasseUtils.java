...
public class MotDePasseUtils {
	...
	public static void main(String[] args) {
		try {
			System.out.println(String.format("bob=%s", MotDePasseUtils.genererMotDePasse("bobIsTheBest")));
			System.out.println(String.format("jean=%s", MotDePasseUtils.genererMotDePasse("azerty")));
			System.out.println(String.format("marie=%s", MotDePasseUtils.genererMotDePasse("123456")));
			System.out.println(String.format("marie=%s", MotDePasseUtils.genererMotDePasse("Admin123")));
